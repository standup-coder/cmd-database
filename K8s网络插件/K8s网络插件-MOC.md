...
- 🔴 [[calicoctl-apply]] — Apply Calico network policy configuration
- 🔴 [[calicoctl-delete-networkpolicy]] — Delete Calico network policy
- 🟡 [[calicoctl-get-networkpolicies]] — List Calico network policies
- 🟡 [[calicoctl-get-nodes]] — List all Calico nodes
- 🟡 [[cilium-connectivity-test]] — Run connectivity test between pods
- 🟡 [[cilium-hubble-status]] — Check Hubble observability status
- 🟡 [[cilium-status]] — Check Cilium agent status
- 🟡 [[istioctl-analyze]] — Analyze Istio configuration for potential issues
...
- 🟡 [[kubectl-get-gateways]] — List Gateway resources (Gateway API)
- 🟡 [[kubectl-get-httproutes]] — List HTTPRoute resources (Gateway API)
